<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ConsultarClientes.aspx.cs" Inherits="MANTENIMIENTOSITIOWEBCLIENTES2023121.ConsultarClientes" %>
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8"/>
    <title>Formulario Consultando Clientes</title>
...
<body bgcolor="lightblue">
    ...
    <br />
    <center>
    <asp:Label ID="Label1" runat="server" Text="Consultando Clientes" Font-Bold="True" Font-Size="28px" ForeColor="Red"></asp:Label>
    </center>
    <hr />
    ...
    <div align="center">
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CLIENTESWEB2023121ConnectionString2 %>" SelectCommand="SELECT * FROM [TABLACLIENTES] WHERE ([IDENTIFICACION] = @IDENTIFICACION)">
            <SelectParameters>
